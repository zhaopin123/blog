    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('WAIT_BUYER_PAY', '交易创建'), ('TRADE_CLOSE', '交易关闭'), ('TRADE_FINISHED', '交易结束'), ('paying', '待支付'), ('TRADE_SUCCESS', '成功')], default='paying', max_length=20, verbose_name='交易状态')),
